            ...
            <div class="row">
                <div class="col-md-8">
                    ...
                    <div class="bg-light p-3">
                        <div class="p-3 d-flex align-items-md-center justify-content-between
                        ...
                        >
                            <div class="mobile-left d-flex flex-column align-content-center
                                ...
                                <!-- img -->
                                <div class="bg-cover my-4 mr-4 d-none d-md-block"
                                    :style="[
                                ...
                                <div class="input-group input-group-sm qty-group">
                                    ...
                                    <div class="input-group-append">
                                        <button class="btn-btn-primary" type="button" id="addButton" @click.prevent="changeQty(item.id, item.product.id, item.qty, true)">+</button>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="col-md-4 mb-6 mb-md-0">
                    <div class="text-light bg-primary-light p-3">
                    ...
                    <!-- 結帳 -->
                    <router-link to="cart/customerinfo" class=" btn btn-block btn-lg btn-primary rounded-0 text-white mx-md-0 py-3">
                        下一步    
                    </router-link> 
                </div>
            </div>
