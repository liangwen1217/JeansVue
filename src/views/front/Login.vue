<template>
    <div>
        <!-- Login -->
        <section class="container mt-5 mb-8 px-0 px-md-3" style="margin-bottom:3rem;">
                ...
                >
                    ...
                    <ValidationProvider
                     ...
                     <div class="custom-control custom-checkbox">
                        ...
                        <button type="submit" class="btn btn-block btn-lg btn-primary text-white my-3 rounded-0">
                        登入
                        </button>
                    </ValidationObserver>
                </div>    
